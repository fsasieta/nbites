...
public class WalkingEngineParameters {//extends JPanel {
     ...
     *
     */
	public String[] listOfParams = new String[] {
   ...
   /* 
    ...
    JTextField[] v4Fields = new JTextField[v4ParamNumber];
    JTextField[] v5Fields = new JTextField[v5ParamNumber];
    for(int i = 0; i < v4ParamNumber; i++){
        v4Fields[i] = new JTextField(String.valueOf(0));
        v4Fields[i].setBounds( 5, 50 + i*25, useV4.getPreferredSize(), useV4/getPreferredSize());
    }
    */
