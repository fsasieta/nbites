...
{
    public final float FIELD_WHITE_WIDTH = 900.f;
    public final float FIELD_WHITE_HEIGHT = 600.f;
    public final float GREEN_PAD_X = 69.5f;
    public final float GREEN_PAD_Y = 69.5f;

    public final float LINE_WIDTH = 5.0f;

    public final float FIELD_GREEN_WIDTH = FIELD_WHITE_WIDTH + 2.0f * GREEN_PAD_X;
    public final float FIELD_GREEN_HEIGHT = FIELD_WHITE_HEIGHT + 2.0f * GREEN_PAD_Y;
    public final float FIELD_WIDTH = FIELD_GREEN_WIDTH;
    public final float FIELD_HEIGHT = FIELD_GREEN_HEIGHT;
        
    public final float CENTER_FIELD_X = FIELD_GREEN_WIDTH * .5f;
    public final float CENTER_FIELD_Y = FIELD_GREEN_HEIGHT * .5f;
    ...
    public final float FIELD_WHITE_BOTTOM_SIDELINE_Y = GREEN_PAD_Y;
    public final float FIELD_WHITE_TOP_SIDELINE_Y = (FIELD_WHITE_HEIGHT +
                                                      GREEN_PAD_Y);
    public final float FIELD_WHITE_LEFT_SIDELINE_X = GREEN_PAD_X;
    public final float FIELD_WHITE_RIGHT_SIDELINE_X = (FIELD_WHITE_WIDTH +
                                                        GREEN_PAD_X);
    
    public final float MIDFIELD_X = FIELD_GREEN_WIDTH * .5f;
    public final float MIDFIELD_Y = FIELD_GREEN_HEIGHT * .5f;
    ...
    public final float CROSSBAR_CM_WIDTH = 150.f;
    ...
    public final float LANDMARK_MY_GOAL_BOTTOM_POST_Y =
    ...
    public final float CENTER_CIRCLE_RADIUS = 75.0f; // Not scaled

    public final float GOALBOX_DEPTH = 60.0f;
    public final float GOALBOX_WIDTH = 220.0f;
    ...
    // kick off positions
    public final Location ODD_DEFENDER_KICKOFF = new Location((int)(MY_GOALBOX_RIGHT_X + 50),
                                                        (int)MY_GOALBOX_BOTTOM_Y); 
    public final Location EVEN_DEFENDER_KICKOFF = new Location((int)(MY_GOALBOX_RIGHT_X + 50),
                                                    (int)MY_GOALBOX_TOP_Y);
    public final Location ODD_CHASER_KICKOFF = new Location((int)(CENTER_FIELD_X - 45),
                                                (int)(OPP_GOALBOX_BOTTOM_Y - 100));
    public final Location EVEN_CHASER_KICKOFF = new Location((int)(CENTER_FIELD_X - 45),
                                                (int)CENTER_FIELD_Y);
